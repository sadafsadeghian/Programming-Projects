...
def display_cover(top, bottom):
    ...
    band_name_font = ImageFont.truetype("arial.ttf", 25)  # 25pt font
    album_name_font = ImageFont.truetype("arial.ttf", 20)  # 20pt font
...
index1=page.find("<title>")
index3=page[index1::].find("\\")
index2=page[index1:index3].find(" - Wikipedia")
print(index1, index2, index3)
title = page[index1+7:index1+index2]
print (title)
...
index2=page[index1:index3].find(" - Wikipedia")
print(index1, index2, index3)
AlbumName = page[index1+7:index1+index2]
print (AlbumName)



#print(page[index1+7:index1+index2])
#print(page[index1+7:index3-8])
album=display_cover(title, AlbumName)
album.show()
saved= album.save('test.png')
#path = "./test.png"
